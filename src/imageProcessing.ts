...
export let imageColorData: Color[] = [];
export let KMeansCalc: KMeansCalculator;
export let width: number = 0;
export let height: number = 0;

export async function getImageData(imageElement: HTMLImageElement): Promise<ImageData> {
...
export async function getDataFromElement(imgElement: HTMLImageElement, fast: boolean) {
...
export function displayImageFromArray(colors: Color[], displayElement: HTMLImageElement, imgWidth: number, imgHeight: number) {
...
export async function quantizeAndDisplay(outputImgElement: HTMLImageElement, debugLabel: HTMLLabelElement, strPalette: String[], _width: number, _height: number): Promise<String[]> {
...
export async function genPalette(k: number, maxIterations: number, debugLabel: HTMLLabelElement, nonGenPalette: Color[]) {
    let startTime = new Date().getTime();
